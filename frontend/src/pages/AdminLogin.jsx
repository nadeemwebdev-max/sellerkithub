...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md w-full glass-panel p-8 sm:p-10 rounded-3xl border border-slate-700/80 shadow-2xl bg-[#0b101c] space-y-8">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="p-3 rounded-xl bg-slate-900/80 border border-slate-800 text-[11px] text-slate-400">
            <p className="font-semibold text-slate-300">🔑 Default Creator Credentials:</p>
            <p>Username: <code className="text-emerald-400">travel_with.nj</code></p>
            <p>Password: <code className="text-emerald-400">TravelNJ@2026</code></p>
          </div>
