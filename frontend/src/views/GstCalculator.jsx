...
export default function GstCalculator({ lang: propLang }) {
  ...
  const gt = (TOOLS_TRANSLATIONS[lang] || TOOLS_TRANSLATIONS.en).gst;
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        <div className="p-4 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#0c1322] shadow-sm">
          <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 block">{gt.metricBase}</span>
          ...
          <span className="text-[11px] text-slate-600 dark:text-slate-400">Excl. Tax</span>
        </div>

        <div className="p-4 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#0c1322] shadow-sm">
          <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 block">{gt.metricTax} ({gstRate}%)</span>
          ...
          <span className="text-[11px] text-slate-600 dark:text-slate-400">Total Tax</span>
        </div>
        ...
        <div className="p-4 rounded-xl border border-emerald-200 dark:border-emerald-500/30 bg-emerald-50/50 dark:bg-emerald-500/10 shadow-sm">
          <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-800 dark:text-emerald-300 block">{gt.metricTotal}</span>
          ...
          <span className="text-[11px] font-bold text-emerald-800 dark:text-emerald-300">Total Price</span>
        </div>
      </div>
