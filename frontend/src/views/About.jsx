...
export default function About({ lang: propLang }) {
      ...
      <div className="p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/[0.02] space-y-4 text-xs">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-slate-600 dark:text-slate-300">
          ...
          <div>
            ...
            <span>Client-Side Static Application</span>
          </div>
          <div>
            <span className="font-semibold text-slate-900 dark:text-slate-200 block">Legal Governance</span>
            <Link to="/privacy-policy" lang={lang} className="text-brand-600 dark:text-brand-400 hover:underline">Privacy Policy</Link> & <Link to="/terms" lang={lang} className="text-brand-600 dark:text-brand-400 hover:underline">Terms of Service</Link>
          </div>
        </div>
      </div>
