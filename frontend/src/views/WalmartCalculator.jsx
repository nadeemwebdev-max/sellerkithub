...
export default function WalmartCalculator({ lang: propLang }) {
...
Calculated with SellerKitHub.com`;
  ...
  const faqs = getFaqsForLang('walmart', lang);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <RelatedTools currentPath="/tools/walmart-fee-calculator" lang={lang} />
    </div>
  );
}
