...
export default function Contact({ lang: propLang }) {
        ...
        <div className="md:col-span-5 space-y-4">
          ...
          <div className="p-5 rounded-2xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/[0.02] text-xs space-y-2">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-[11px] leading-relaxed">
              ...
              <Link to="/amazon-fee-calculator" lang={lang} className="text-brand-600 dark:text-brand-400 underline">Amazon FBA Calculator</Link>{' '}
              or{' '}
              <Link to="/etsy-fee-calculator" lang={lang} className="text-brand-600 dark:text-brand-400 underline">Etsy Calculator</Link>.
            </p>
          </div>
        </div>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="contact-name" className="block text-xs font-semibold text-slate-800 dark:text-slate-200 mb-1">
                    Your Name
                  </label>
                  <input
                    id="contact-name"
                ...
                <div>
                  <label htmlFor="contact-email" className="block text-xs font-semibold text-slate-800 dark:text-slate-200 mb-1">
                    Your Email Address *
                  </label>
                  <input
                    id="contact-email"
              ...
              <div>
                <label htmlFor="contact-subject" className="block text-xs font-semibold text-slate-800 dark:text-slate-200 mb-1">
                  Topic / Inquiry Subject
                </label>
                <select
                  id="contact-subject"
                  aria-label="Topic / Inquiry Subject"
                  value={subject}
              ...
              <div>
                <label htmlFor="contact-message" className="block text-xs font-semibold text-slate-800 dark:text-slate-200 mb-1">
                  Message *
                </label>
                <textarea
                  id="contact-message"
