...
export default function RoasCalculator({ lang: propLang }) {
  ...
  const rt = (TOOLS_TRANSLATIONS[lang] || TOOLS_TRANSLATIONS.en).roas;
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        <div className="p-4 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#0c1322] shadow-sm">
          <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 block">{rt.metricTargetRoas}</span>
        ...
        <div className="p-4 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#0c1322] shadow-sm">
          <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 block">{rt.metricBreakEvenRoas}</span>
          ...
          <span className="text-[11px] text-slate-500">Min. Ratio</span>
        </div>

        <div className="p-4 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#0c1322] shadow-sm">
          <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 block">{rt.metricMaxCac}</span>
        ...
        <div className={`p-4 rounded-xl border shadow-sm ${
          ...
          <span className={`text-[11px] font-bold block ${
            ...
            {result.netMarginPct.toFixed(1)}% {rt.metricAdMargin}
          </span>
        </div>
      </div>
      ...
      {/* Related Tools */}
      <RelatedTools currentPath="/tools/roas-calculator" lang={lang} />
